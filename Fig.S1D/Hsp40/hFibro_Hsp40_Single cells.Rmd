---
title: "Figure S1D: TetON Cells / Hsp40"
...
```{r Fig,S1_D, fig.width=4,fig.height=4.5, echo = FALSE}
bioreps_tbl %>%
...
Define a custom function to run a Dunnett post-hoc test only on the Mean marker intensity sum (Cyto + Nucleus), using the cell line as the predictor variable, and fixing WT as the negative control. The output of the Dunnett's test is then rearranged to a tidy table to make it work with `dplyr`.
